  ...
  return (
    <SettingCard>
      ...
      <div className="flex items-center gap-3.5">
        <div className="flex size-13 shrink-0 items-center justify-center rounded-full bg-accent-soft text-[18px] font-semibold text-accent">
          {initials}
        </div>
        <div>
        ...
        <span className="rounded-[8px] border border-accent-border bg-accent-soft px-2.5 py-1 text-[12px] font-semibold text-accent">
